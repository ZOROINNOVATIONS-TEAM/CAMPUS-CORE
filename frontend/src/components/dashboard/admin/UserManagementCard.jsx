  ...
  return (
    <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-5 sm:p-6 flex flex-col min-h-[220px] w-full">
      ...
      <div className="flex gap-3 mb-3">
        <div className="flex-1 bg-blue-50 dark:bg-blue-950 rounded-lg p-3 flex items-center gap-2">
          <Users className="w-5 h-5 text-blue-500" />
          <div>
            <div className="text-xs text-gray-700 dark:text-gray-300">Total Students</div>
            <div className="font-bold text-gray-900 dark:text-white">
              {users.students?.toLocaleString?.() || 0}
            </div>
          </div>
        </div>
        <div className="flex-1 bg-purple-50 dark:bg-purple-950 rounded-lg p-3 flex items-center gap-2">
          <Users className="w-5 h-5 text-purple-500" />
          <div>
            <div className="text-xs text-gray-700 dark:text-gray-300">Total Faculty</div>
            <div className="font-bold text-gray-900 dark:text-white">
              {users.faculty?.toLocaleString?.() || 0}
            </div>
          </div>
        </div>
      </div>
