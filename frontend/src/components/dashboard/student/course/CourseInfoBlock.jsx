...
export function CourseInfoBlock({ type, label, sublabel }) {
  return (
    <div className="flex flex-col items-center justify-center border border-gray-200 rounded-md p-3 w-full min-w-[110px] text-center cursor-pointer hover:bg-gray-100 transition">
      <div className="text-indigo-600 mb-1">{iconsMap[type]}</div>
