      ...
      <div className="flex flex-col md:flex-row gap-4">
        <div className="flex-1 flex flex-col gap-3">
          <div className="flex items-center gap-2 bg-blue-50 p-4 rounded-lg">
            ...
            <div>
              <div className="text-xs text-gray-500 font-medium">Total Fees</div>
          ...
          <div className="flex items-center gap-2 bg-green-50 p-4 rounded-lg">
            ...
            <div>
              ...
              <div className="text-xl font-bold">$8,750</div>
            </div>
          </div>
        </div>
        <div className="flex-1 flex flex-col gap-3">
          <div className="flex items-center gap-2 bg-yellow-50 p-4 rounded-lg">
            ...
            <div>
              <div className="text-xs text-gray-500 font-medium">Pending Balance</div>
              <div className="text-xl font-bold">$3,750</div>
            </div>
          </div>
          <div className="flex items-center gap-2 bg-purple-50 p-4 rounded-lg">
            <ReceiptText className="text-purple-600 w-6 h-6" />
            <div>
              <div className="text-xs text-gray-500 font-medium">Last Payment</div>
