...
function StaticMap() {
  return (
    <div className="w-full h-[250px] rounded-lg overflow-hidden border bg-gray-100 flex items-center justify-center">
      <iframe
        title="Campus Map"
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="flex flex-wrap justify-between items-center mb-4">
          <div>
            ...
            <p className="text-sm text-gray-600">Manage and locate your teaching spaces and faculty facilities</p>
            <div className="flex gap-2 mt-1">
              <button className="text-blue-600 text-xs underline">Show My Classes</button>
              <button className="text-blue-600 text-xs underline">Book a Room</button>
            </div>
          </div>
          <button className="bg-blue-100 text-blue-600 rounded-lg px-4 py-1 text-sm font-medium hover:bg-blue-200">
            Download Map
          </button>
        </div>
          ...
          <div className="flex-1">
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 mb-6">
              <div className="flex flex-wrap gap-2 items-center mb-3">
                ...
                <button className="ml-2 text-gray-500 text-xs px-2 py-1 hover:bg-gray-100 rounded">
                  ⟳
                </button>
              </div>
              <div className="w-full h-[320px] rounded-lg overflow-hidden border bg-gray-100 flex items-center justify-center">
                <iframe
                  title="Campus Map"
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3532.026842195695!2d85.31690977540636!3d27.71624107618443!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39eb191203b250e9%3A0x8e870af6c21f30c1!2sTribhuvan%20University!5e0!3m2!1sen!2sin!4v1718888928412!5m2!1sen!2sin"
                  width="100%"
