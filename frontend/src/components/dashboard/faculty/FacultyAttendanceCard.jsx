...
export default function FacultyAttendanceCard() {
  ...
  return (
    <div className="bg-white dark:bg-[#121212] rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 p-6 flex flex-col gap-6">
      {/* Header */}
      ...
      <div className="flex gap-3 mt-2">
        <button className="flex-1 py-2 rounded-xl border border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-300 bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 transition">
          Cancel
        </button>
        <button className="flex-1 py-2 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-medium transition">
          Submit Attendance
        </button>
      </div>
    </div>
