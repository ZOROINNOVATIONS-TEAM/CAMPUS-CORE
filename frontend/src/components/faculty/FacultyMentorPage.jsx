...
import { FaUserCircle, FaSearch, FaPaperPlane, FaMicrophone, FaUser, FaPhone, FaCog } from "react-icons/fa";
...
export default function FacultyMentorPage() {
  ...
  // For Calls tab, show a placeholder (can integrate with backend)
