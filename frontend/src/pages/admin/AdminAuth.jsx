...
export default function AdminAuth() {
  ...
  return (
    <div className="h-screen flex flex-col md:flex-row">
      ...
      <div className="hidden md:flex md:w-1/2 bg-blue-700 text-white relative overflow-hidden flex items-center justify-center">
        <img
      ...
      <div className="w-full md:w-1/2 bg-gray-100 p-6 md:p-10 flex flex-col justify-center">
        <div className="max-w-md mx-auto w-full">
          ...
          <div className="flex justify-center gap-4 mb-6">
            <button
              ...
              className={`px-5 py-2 rounded-md font-medium ${mode === "login" ? "bg-indigo-600 text-white" : "bg-white text-gray-600"}`}
            >Login</button>
            <button
              onClick={() => setMode("register")}
              className={`px-5 py-2 rounded-md font-medium ${mode === "register" ? "bg-indigo-600 text-white" : "bg-white text-gray-600"}`}
            >Register</button>
          </div>
          ...
          {mode === "login" ? (
            ...
            <form onSubmit={handleRegister} className="space-y-4">
              ...
              <div className="relative">
                <UserIcon className="w-5 h-5 absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400" />
                <input
                  type="text"
              ...
              <div className="relative">
                <BuildingOfficeIcon className="w-5 h-5 absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400" />
                <input
                  type="text"
              ...
              <div className="relative">
                ...
                />
                <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute right-3 top-1/2 transform -translate-y-1/2">
                  {showPassword ? <EyeIcon className="w-5 h-5 text-gray-400" /> : <KeyIcon className="w-5 h-5 text-gray-400" />}
                </button>
              </div>
              {regPassError && <p className="text-red-500 text-xs">{regPassError}</p>}

              <div className="relative">
                <LockClosedIcon className="w-5 h-5 absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400" />
                <input
                  type="password"
          ...
          <div className="mt-6">
            ...
            <button type="button" className="w-full flex items-center justify-center gap-3 rounded-md py-2 hover:bg-gray-200 transition">
