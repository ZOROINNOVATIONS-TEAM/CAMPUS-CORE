...
const HomeTab = () => {
  return (
    <div className="mt-6 space-y-6">
      {/* Top Grid: Total Users + Upcoming Events */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              { title: "Attendance", color: "text-blue-600", updated: "today" },
              { title: "Performance", color: "text-purple-600", updated: "yesterday" },
              { title: "Courses", color: "text-green-600", updated: "2 days ago" },
              { title: "Finance", color: "text-pink-600", updated: "3 days ago" },
            ].map((item, i) => (
              <div key={i} className="bg-gray-50 p-3 rounded-lg border border-gray-200">
                <p className={`font-semibold ${item.color} text-sm`}>{item.title}</p>
                <p className="text-xs text-gray-500 mt-1">Updated {item.updated}</p>
              </div>
            ))}
          </div>
        </div>
