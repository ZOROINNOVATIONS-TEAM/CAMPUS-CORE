...
const Schedule = () => {
  ...
  return (
    <section className="p-4 sm:p-6 md:p-10 bg-gray-100 dark:bg-gray-900 min-h-screen transition-colors duration-200">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Calendar and Events */}
        <div className="bg-white dark:bg-gray-800 p-4 sm:p-6 rounded-xl shadow border border-gray-200 dark:border-gray-700 transition-colors duration-200">
          {/* Header */}
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-100">Calendar</h3>
            <div className="text-sm font-medium dark:text-gray-100">Spring Summer</div>
          </div>

          {/* Calendar */}
          <div className="grid grid-cols-7 gap-2 mb-4 text-center text-gray-700 dark:text-gray-100">
            <div className="col-span-7 flex justify-between items-center text-sm mb-2">
              <button>&lt;</button>
              <span className="font-medium">January 2025</span>
              <button>&gt;</button>
            ...
            {["Mo", "Tu", "We", "Th", "Fr", "Sa", "Su"].map((day) => (
              <div key={day} className="text-xs font-semibold text-gray-500 dark:text-gray-300">{day}</div>
            ))}
            {[...Array(31)].map((_, i) => (
              <div
                key={i}
          ...
          {/* Radio Filter */}
          <div className="mb-4">
            <label className="block font-semibold mb-1 text-sm dark:text-gray-100">Event Type</label>
            <div className="flex gap-4 text-sm">
              <label className="flex items-center gap-1">
                <input type="radio" value="Lecture" checked={eventType === "Lecture"} onChange={handleRadioChange} />
                Lecture
          ...
          {/* Upcoming Events */}
          <div>
            <h4 className="font-semibold text-sm mb-2 dark:text-gray-100">Upcoming Events</h4>
            <div className="bg-blue-50 dark:bg-blue-900 border-l-4 border-blue-500 dark:border-blue-400 p-3 rounded mb-2 text-sm">
              <p className="font-medium text-blue-700 dark:text-blue-300">🧑‍🏫 Personal Coaching - With Yashasvi</p>
              <p className="text-xs text-gray-600 dark:text-gray-300">Coaching in College | Jan 17, 12:30 PM</p>
            </div>
            <div className="border dark:border-gray-700 p-3 rounded text-sm text-gray-700 dark:text-gray-300">
              <p className="font-medium">📅 Registration Conference</p>
              <p className="text-xs text-gray-600 dark:text-gray-300">Admin Office | Jan 17, 10:00 AM</p>
            </div>
          </div>
        </div>
        ...
        {/* Add Event Panel */}
        <div className="bg-white dark:bg-gray-800 p-4 sm:p-6 rounded-xl shadow border border-gray-200 dark:border-gray-700 transition-colors duration-200">
          <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-4">Add Event</h3>
          <button className="bg-blue-600 hover:bg-blue-700 text-white w-full py-2 rounded-md mb-6 text-sm font-medium transition">
            + Add New Event
          </button>

          {/* Saved Templates */}
          <h4 className="text-sm font-semibold text-gray-700 dark:text-gray-200 mb-2">Saved Templates</h4>
          <div className="space-y-3 text-sm">
            <div className="border dark:border-gray-700 p-3 rounded text-gray-700 dark:text-gray-200 bg-purple-50 dark:bg-purple-900">
              🧑‍🏫 Personal Coaching <br />
              <span className="text-xs text-gray-500 dark:text-gray-400">Jan 22, 12:30 PM</span>
            </div>
            <div className="border dark:border-gray-700 p-3 rounded text-gray-700 dark:text-gray-200 bg-indigo-50 dark:bg-indigo-900">
              📘 Group Study <br />
              <span className="text-xs text-gray-500 dark:text-gray-400">Jan 23, 11:00 AM</span>
            </div>
            <div className="border dark:border-gray-700 p-3 rounded text-gray-700 dark:text-gray-200 bg-pink-50 dark:bg-pink-900">
              🎓 Introductory Lecture <br />
              <span className="text-xs text-gray-500 dark:text-gray-400">Jan 24, 9:00 AM</span>
            </div>
            <div className="border dark:border-gray-700 p-3 rounded text-gray-700 dark:text-gray-200 bg-yellow-50 dark:bg-yellow-900">
              📑 Assignment Deadline <br />
              <span className="text-xs text-gray-500 dark:text-gray-400">Jan 26, 5:00 PM</span>
            </div>
            <div className="border dark:border-gray-700 p-3 rounded text-gray-700 dark:text-gray-200 bg-blue-50 dark:bg-blue-900">
              🎤 Presentation Day <br />
              <span className="text-xs text-gray-500 dark:text-gray-400">Jan 28, 10:00 AM</span>
            </div>
          </div>
        </div>
      </div>
